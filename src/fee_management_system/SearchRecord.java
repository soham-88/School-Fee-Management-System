...
public class SearchRecord extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(SearchRecord.class.getName());
    ...
    public void setRecordsToTable()
    {
        try {
            ...
            while(rs.next()) {
                ...
                Object[] obj = {receiptNo,rollNo,studentName,paymentMode,courseName,amount};
    ...
    private void initComponents() {
        ...
        panelHome.add(btnHome1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 120, 40));
        ...
        panelHome.add(btnHome2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 120, -1));

        panelsideBar.add(panelHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 50, 400, 70));
        ...
        panelSearch.add(btnSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, 250, 40));
        ...
        panelSearch.add(btnHome3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 120, 70));

        panelsideBar.add(panelSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, 400, 70));
        ...
        panelEdit.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 200, 40));
        ...
        panelEdit.add(btnHome4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 120, 70));
        ...
        panelCourseList.add(btnCourseList, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 200, 40));
        ...
        panelCourseList.add(btnHome5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 120, 70));

        panelsideBar.add(panelCourseList, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 350, 400, 70));
        ...
        panelViewAllRecord.add(btnViewAllRecord, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, 270, 40));
        ...
        panelViewAllRecord.add(btnHome6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 120, 70));

        panelsideBar.add(panelViewAllRecord, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 450, 400, 70));
        ...
        panelBack.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, 100, 40));
        ...
        panelsideBar.add(panelBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 550, 400, 70));
        ...
        panelLogout.add(btnLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 140, -1));
        ...
        panelsideBar.add(panelLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 660, 400, 70));
        ...
        tbl_studentdata.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Receipt no", "Roll no", "Student name", "Payment mode", "Course name", "Amount"
            }
        ));
        jScrollPane1.setViewportView(tbl_studentdata);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 200, 720, 550));

        jLabel1.setFont(new java.awt.Font("Palatino Linotype", 1, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Search Record");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 30, 340, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Enter Search String :");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 140, 240, -1));
        ...
        jPanel1.add(txt_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 140, 380, 40));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, 520, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, 1330, 850));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new SearchRecord().setVisible(true));
    }
