...
public class UpdateFeesDetails extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(UpdateFeesDetails.class.getName());
    private String sql;
    ...
    public String updatedata()
    {
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("update fees_details set student_name =?,roll_no =?,payment_mode =?, "
                    + "cheque_no =?,bank_name =?,dd_no =?,course_name =?,gstin =?,total_amount =?,date =?,amount =?,cgst =?,sgst =?,"
                    + "total_in_words =?,remark =?,year1 =?,year2 =? where reciept_no =?");
    ...
    private void initComponents() {
        ...
        panelHome.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
                panelHomeCaretPositionChanged(evt);
            }
        ...
        panelHome.add(btnHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 10, 130, 40));

        btnLogout6.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnLogout6.setForeground(new java.awt.Color(255, 255, 255));
        btnLogout6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fee_management_system/images/home.png"))); // NOI18N
        panelHome.add(btnLogout6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 70, 70));

        panelsideBar.add(panelHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, 390, 70));
        ...
        panelSearch.add(btnSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 250, 40));

        btnLogout.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnLogout.setForeground(new java.awt.Color(255, 255, 255));
        btnLogout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fee_management_system/images/search2.png"))); // NOI18N
        panelSearch.add(btnLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 70, 70));

        panelsideBar.add(panelSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 390, 70));
        ...
        panelEdit.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 210, 40));

        btnLogout5.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnLogout5.setForeground(new java.awt.Color(255, 255, 255));
        btnLogout5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fee_management_system/images/edit2.png"))); // NOI18N
        panelEdit.add(btnLogout5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 70, 70));

        panelsideBar.add(panelEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 270, 390, 70));
        ...
        panelCourseList.add(btnCourseList, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 230, 40));

        btnLogout7.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnLogout7.setForeground(new java.awt.Color(255, 255, 255));
        btnLogout7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fee_management_system/images/list_1.png"))); // NOI18N
        panelCourseList.add(btnLogout7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 70, 70));

        panelsideBar.add(panelCourseList, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 370, 390, 70));
        ...
        panelViewAllRecord.add(btnViewAllRecord, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 280, 40));

        btnLogout8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnLogout8.setForeground(new java.awt.Color(255, 255, 255));
        btnLogout8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fee_management_system/images/view all record.png"))); // NOI18N
        panelViewAllRecord.add(btnLogout8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 70, 70));

        panelsideBar.add(panelViewAllRecord, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 470, 390, 70));
        ...
        panelBack.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, 110, 40));

        btnLogout2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnLogout2.setForeground(new java.awt.Color(255, 255, 255));
        btnLogout2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fee_management_system/images/left-arrow.png"))); // NOI18N
        panelBack.add(btnLogout2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 70, 70));

        panelsideBar.add(panelBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 570, 390, 70));
        ...
        btnLogout1.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        btnLogout1.setForeground(new java.awt.Color(255, 255, 255));
        btnLogout1.setText("Logout");
        panelLogout.add(btnLogout1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 0, 130, 50));

        btnLogout3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnLogout3.setForeground(new java.awt.Color(255, 255, 255));
        btnLogout3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fee_management_system/images/logout.png"))); // NOI18N
        panelLogout.add(btnLogout3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 70, 70));

        btnLogout4.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnLogout4.setForeground(new java.awt.Color(255, 255, 255));
        btnLogout4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fee_management_system/images/logout.png"))); // NOI18N
        panelLogout.add(btnLogout4, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 550, 70, 70));

        panelsideBar.add(panelLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 670, 390, 70));
        ...
        panelParent.add(txt_GSTNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 60, 110, -1));
        ...
        panelParent.add(lbl_DDno, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 130, 110, 30));
        ...
        panelParent.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 20, 110, 30));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel8.setText("GSTIN :");
        panelParent.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 60, 110, -1));
        ...
        panelParent.add(txt_receiptNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 30, 140, 30));
        ...
        panelParent.add(txt_DDNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 130, 140, 30));
        ...
        panelParent.add(txt_ChequeNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 130, 140, 30));
        panelParent.add(dateChooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 20, 140, 30));
        ...
        jLabel11.setText("the followingschool office for the year");
        ...
        panelChild.add(txt_year1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 40, 70, 30));
        ...
        panelChild.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 330, 260, -1));
        ...
        panelChild.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 290, 130, 30));
        ...
        panelParent.add(panelChild, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 230, 580, 430));

        lbl_bankName.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lbl_bankName.setText("Bank Name :");
        panelParent.add(lbl_bankName, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 180, 110, 30));
        ...
        panelParent.add(combo_PaymentMode, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 80, 140, 30));
        ...
        panelParent.add(txt_bankName, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 180, 370, 30));
    ...
    private void panelHomeCaretPositionChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_panelHomeCaretPositionChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_panelHomeCaretPositionChanged
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new UpdateFeesDetails().setVisible(true));
    }
    ...
    private javax.swing.JLabel btnLogout7;
    private javax.swing.JLabel btnLogout8;
